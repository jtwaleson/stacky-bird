    ...
    <vue-final-modal v-model="showLevelCompletedModal">
        <div class="levelfinishpopup">
            ...
            <div v-if="unlocksLevels.length > 0">
                ...
                <span style="font-weight: bold" v-for="level in unlocksLevels" :key="level"
                    >{{ level }}
                </span>
            </div>
    ...
    <div class="main">
        ...
        <div class="boarddd">
            <div class="board" :style="boardStyle">
                ...
                <Instruction
                    v-for="(levelTile, index) in allTiles"
                    :key="index"
                    v-bind="levelTile"
                    unlocked
...
export default {
    ...
    methods: {
        ...
        drop(x, y, event) {
            ...
            if (deleteX && deleteY) {
                this.userPlacedTiles = this.userPlacedTiles.filter(
            ...
            if (this.validation) {
                for (let testCaseIndex in this.validation) {
                    if (this.validation[testCaseIndex] === this.selectedTestCase) {
                        ...
                        toast.info(
                            this.$tr(`Test case {testCaseIndex} done!`, {
